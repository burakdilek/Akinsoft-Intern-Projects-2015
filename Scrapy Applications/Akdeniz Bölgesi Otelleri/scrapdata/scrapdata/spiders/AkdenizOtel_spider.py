...
class tripadvisorSpider(CrawlSpider):
    ...
    for i in my_range(0, 1710, 30):
        start_urls.append('http://www.tripadvisor.com.tr/Hotels-g658661-oa'+str(i)+'-Turkish_Mediterranean_Coast-Hotels.html')
    rules = [Rule(LinkExtractor(allow=['/Hotel_Review.*']), 'parse_page')]
    def parse_page(self, response):

        item = items.AkdenizotelscrapItem()
